...
static void siginfoHandler(int sig,siginfo_t *si,void *ucontext) {
	/*UNSAFE: This handler uses non-aysnc-signal-safe functions
...
int main(int argc,char *argv[]) {
	...
	mask all other signals to prevent handlers recursive interrupting
	...
	while(!allDone) //wait for imcoming signals
		pause();
}
